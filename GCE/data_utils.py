...
#
# def get_template(fermi_folder, temp, smooth_P=True, smooth_PS=False):  #, model_O=False)
#     """
#     Returns a template.
...
#     :return: template
#     """
#     #kontrolliere ob gesmootht oder ungesmooth bei poitnsourcers standard
#     if smooth_P == False:
#         if temp == "iso":
